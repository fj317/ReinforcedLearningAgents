...
def plot_results(mc_rewards = None, sarsa_rewards = None, q_learning_rewards = None) :
	...
	if (mc_rewards is not None):
		...
		plt.plot(range(num_episodes), mc_average_episode_rewards)
	...
	if (sarsa_rewards is not None):
		...
		# Plot unsmoothed learning curve.    
		plt.plot(range(num_episodes), sarsa_average_episode_rewards)
	...
	if (q_learning_rewards is not None):
		...
		# Plot unsmoothed learning curve.    
		plt.plot(range(num_episodes), q_learning_average_episode_rewards)
...
def plot_combined_results(mc_rewards = None, sarsa_rewards = None, q_learning_rewards = None) :
	num_episodes = 150
...
def plot_modified_agent_results(q_learning_rewards = None, modified_agent_rewards = None) :
	num_episodes = 150
